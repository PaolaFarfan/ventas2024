...
<body>
    <style>
        ...
        * {
        ...
        .overlay {
            background: #a892a0;
            background: -webkit-linear-gradient(to right, #FF416C, #c994b4);
            background: linear-gradient(to right, #FF416C, #c2b1bb);
    ...
    <script>
        const base_url = '<?php echo BASEE_URL; ?>';
    </script>
    ...
    <script src="<?php echo BASEE_URL ?>views/js/functions_login.js"></script>
    <script>
